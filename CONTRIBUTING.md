...
- Proposals for new `x-` extension fields
...
1. Open an Issue for discussion before submitting a Pull Request
2. Link your PR to the corresponding Issue
3. Keep PRs small and focused; one PR, one thing
4. For protocol text changes, please update both the English and Chinese versions
...
1. You grant the project maintainers a perpetual, worldwide, royalty-free, irrevocable license to use, reproduce, modify, and distribute your contribution in any manner.
...
All protocol specification texts are released under the Apache 2.0 license.
Reference implementation code is released under the MIT license.
